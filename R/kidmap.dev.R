    ...
    indivPlot <- function(est, SE, thetas, use.hist, yRange) {
        ...
        par( xpd = NA)
        points( c( -.2,-.2), c(est - SE, est + SE), ylim = yRange, xlim = c(0,1), ylab = "", xlab = "", type = "l", lwd = 5, lend=2, col = 'grey70')
        ...
        points(-.2,est, ylim = yRange, xlim = c(0,1), ylab = "", xlab = "", pch = 15, cex = .6)
